...
type TelegramClient interface {
	...
	Sign(ctx context.Context, in *SignMessage, opts ...grpc.CallOption) (*SignResult, error)
...
func (c *telegramClient) Sign(ctx context.Context, in *SignMessage, opts ...grpc.CallOption) (*SignResult, error) {
	out := new(SignResult)
...
type TelegramServer interface {
	...
	Sign(context.Context, *SignMessage) (*SignResult, error)
...
func (UnimplementedTelegramServer) Sign(context.Context, *SignMessage) (*SignResult, error) {
